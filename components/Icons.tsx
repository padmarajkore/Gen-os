...
export const RainIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M16 13.54C16 11.03 14 9 11.5 9s-4.5 2.03-4.5 4.54"></path>
    <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"></path>
    <path d="M8 17.01V17"></path><path d="M12 19v.01"></path><path d="M16 17v.01"></path>
  </svg>
);
...
export const StormIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M21.74 18A5.002 5.002 0 0 0 18 8h-1.26A8 8 0 1 0 4 16.25" />
      <path d="m13 12-4 5h9l-4 5" />
    </svg>
);
